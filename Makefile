...
CXXFLAGS = -g -I./include -I./src/dlib/all/source.cpp -I/usr/X11/include -ljpeg -mavx -lm -framework OpenGL -framework GLUT -lpthread -L/usr/X11/lib/ -lX11 -DDLIB_HAVE_BLAS -DNDEBUG  -DDLIB_JPEG_SUPPORT -DDLIB_HAVE_AVX  -O3 `pkg-config --cflags opencv`

# Linker flags
# When you need to add a library
LDFLAGS = -ljpeg -mavx -lm -framework OpenGL -framework GLUT -lpthread -L/usr/X11/lib/ -lX11 `pkg-config --libs opencv` -DDLIB_HAVE_BLAS -DNDEBUG  -DDLIB_JPEG_SUPPORT -DDLIB_HAVE_AVX  -O3
